...
void
StreamingServerHelper::SetAttribute (
  std::string name,
...
StreamingServerHelper::Install (Ptr<Node> node) const
{
  return ApplicationContainer (InstallPriv (node));
}

ApplicationContainer
StreamingServerHelper::Install (std::string nodeName) const
{
...
ApplicationContainer
StreamingServerHelper::Install (NodeContainer c) const
{
